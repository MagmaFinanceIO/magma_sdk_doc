...
const pool = await buildTestPool(
  sdk,
  TokensMapping.USDT_USDC_LP.poolObjectIds[0],
);
...
const amountA = toDecimalsAmount(
  coinAmounts.amountA.toFixed(6, Decimal.ROUND_UP).toString(),
  6,
);
const amountB = toDecimalsAmount(
  coinAmounts.amountB.toFixed(6, Decimal.ROUND_UP).toString(),
  6,
);
